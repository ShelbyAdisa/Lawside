        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-8 bg-white rounded-lg shadow-lg">
              ...
              <h3 className="text-xl font-semibold mb-4">Qualified Lawyers</h3>
              <p className="text-gray-600">
                Connect with experienced, licensed lawyers who specialize in various areas of law.
              </p>
            </div>
            ...
            <div className="text-center p-8 bg-white rounded-lg shadow-lg">
              ...
              <p className="text-gray-600">
                Your consultations are protected by attorney-client privilege and secure technology.
              </p>
            </div>
          </div>
        </div>
